...
class GeometryQuizPage extends StatefulWidget {
  @override
  _GeometryQuizPageState createState() => _GeometryQuizPageState();
}

class _GeometryQuizPageState extends State<GeometryQuizPage> {
  ...
  final List<Map<String, dynamic>> _questions = [
    {
      'question': 'What are the types of angles formed when two lines meet?',
      'options': [
        'Acute, right, obtuse',
        'Sharp, round, flat, and wide',
        'Tall, short, wide, and narrow',
      ],
      'correctAnswer': 0,
    },
    {
      'question': 'Which type of triangle has all sides and angles equal?',
      'options': [
        'Isosceles triangle',
        'Scalene triangle',
    ...
    {
      'question': 'What is the sum of the angles in any quadrilateral?',
      'options': [
        '180 degrees',
        '360 degrees',
        '90 degrees',
    ...
    {
      'question': 'What is the distance from the center of a circle to any point on the circle called?',
      'options': [
        'Diameter',
        'Radius',
        'Circumference',
