...
class HumanHeart extends StatefulWidget {
  @override
  _HumanHeartState createState() => _HumanHeartState();
}

class _HumanHeartState extends State<HumanHeart> {
  ...
  final List<Map<String, dynamic>> _questions = [
    ...
    {
      'question': 'What are the names of the upper chambers of the heart?',
      'options': [
        'Ventricles',
        'Atria',
        'Valves',
