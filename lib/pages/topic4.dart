...
class _Topic4State extends State<Topic4> {
  ...
  final List<Map<String, dynamic>> _questions = [
    {
      'question': 'What do you need when it rains to stay dry?',
      'options': [
        'A hat',
        'Sunglasses',
    ...
    {
      'question': 'What is the weather like when the sun is shining bright?',
      'options': [
        'Snowy',
        'Sunny',
        'Windy',
    ...
    {
      'question': 'Which weather condition happens when it is very cold and snowflakes fall from the sky?',
      'options': [
        'Rain',
        'Snow',
        'Wind',
    ...
    {
      'question': 'What happens to the leaves during autumn (fall)?',
      'options': [
        'They bloom',
    ...
    },
    {
      ...
      'options': [
        'Because the Earth moves closer to the moon',
