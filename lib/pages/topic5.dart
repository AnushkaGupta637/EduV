  ...
  final List<Map<String, dynamic>> _questions = [
    {
      ...
      'options': [
        'Special objects that can attract certain metals',
        'Objects that can attract plastic',
        'Objects that can only be found in nature',
      ],
      'correctAnswer': 0,
    },
    {
      'question': 'What are the two main properties of magnets?',
      'options': [
        'Attraction and rotation',
        'Attraction and repulsion',
        'Repulsion and conduction',
      ],
      'correctAnswer': 1,
    },
    {
    ...
    {
      'question': 'What will happen if you try to put two North Poles of magnets together?',
      'options': [
